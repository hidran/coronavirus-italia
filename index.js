/*! Add your copyright here. It is included at the beginning of your bundle. */
...
function drawVisualization(eleid, dataRegion) {
  ...
  var dati = [['Region', 'Casi', 'Tamponi', 'Deceduti', 'Ospedalizzati']];
  dataRegion.forEach(function (reg) {
    // const tokens = reg.data.substring(0,12).split('-')
    var dateFormatted = new Date(reg.data);
    dati.push([dateFormatted.toLocaleDateString(), reg.totale_casi, reg.tamponi, reg.deceduti, reg.totale_ospedalizzati]);
  });
  var options = {
    width: 600,
...
function drawLatestVisualization(eleid, dataRegion) {
  ...
  var dati = [['Region', 'Casi', 'Tamponi', 'Deceduti', 'Ospedalizzati']];
  dataRegion.forEach(function (reg) {
    dati.push([reg.denominazione_regione, reg.totale_casi, reg.tamponi, reg.deceduti, reg.totale_ospedalizzati]);
  });
  var data = google.visualization.arrayToDataTable(dati);
  console.log(dati);
  var options = {
...
var mapBoxToken = 'pk.eyJ1IjoiaGlkcmFuIiwiYSI6ImNrN3Z4YXd1ZzFidGUzZXBneThlNjhlZ2cifQ.MA7_4jQcrFPSxRv5kwldGg';
function getConfig() {
  return {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCachedData", function() { return getCachedData; });
...
function getCachedData() {
  ...
  var olddata = localStorage.getItem('cacheData');
  ...
  try {
    var cacheData = JSON.parse(olddata);

    if (!cacheData) {
      return res;
    }

    if (isSameDay(new Date(cacheData.created_at), new Date())) {
      return cacheData;
    }
  } catch (e) {
    return ret;
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var cacheData, _getConfig, dataRegionUrl, data, regions, todaysData;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _getConfig = Object(_config__WEBPACK_IMPORTED_MODULE_0__["getConfig"])(), dataRegionUrl = _getConfig.dataRegionUrl;
            _context.next = 7;
            return fetch(dataRegionUrl).then(function (res) {
              return res.json();
            });
...
function showData() {
  var region = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Lombardia';
...
function _setLatLong() {
  _setLatLong = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(map) {
          ...
          case 0:
            ...
            if (navigator.geolocation) {
              navigator.geolocation.getCurrentPosition(function (position) {
                var _getConfig2 = Object(_config__WEBPACK_IMPORTED_MODULE_0__["getConfig"])(),
                    mapZoom = _getConfig2.mapZoom;
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getData"])().then(function (regdata) {
    console.log(regdata);
    ...
    google.charts.setOnLoadCallback(function () {
      Object(_charts__WEBPACK_IMPORTED_MODULE_1__["drawVisualization"])('all_div', Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["filterData"])(data));
      Object(_charts__WEBPACK_IMPORTED_MODULE_1__["drawLatestVisualization"])('latest_div', todaysData);
    });
    var combo = document.querySelector('#regions');
    combo.addEventListener('change', function (e) {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["updateGraph"])(e.target);
    });
    var oldvalue = combo.value;
    combo.options.remove(0);
    regionArr.sort().forEach(function (ele) {
...
window.addEventListener('load', function () {
  ...
  var _getConfig = Object(_config__WEBPACK_IMPORTED_MODULE_2__["getConfig"])(),
      tileLayer = _getConfig.tileLayer,
      attribution = _getConfig.attribution,
      tileId = _getConfig.tileId;
  ...
  Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getData"])().then(function (regdata) {
    ...
    if (regions) {
      ...
      var firstReg = regions[regionNames[0]];
      mymap.setView([firstReg.lat, firstReg["long"]], 5);
      Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["setLatLong"])(mymap);
      regionNames.forEach(function (name) {
        var regData = regions[name];
        var firstRegionData = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["filterData"])(todaysData, name);
        var _firstRegionData$ = firstRegionData[0],
            deceduti = _firstRegionData$.deceduti,
            whatDate = _firstRegionData$.data,
            casi = _firstRegionData$.totale_casi;
        ...
        }).addTo(mymap).bindPopup(function (e) {
          var _e$options = e.options,
              name = _e$options.name,
              deceduti = _e$options.deceduti,
              casi = _e$options.casi;
          Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["showData"])(name);
          combo.value = name;
          var html = '<p>' + name + '  ' + casi + ' casi</p>';
          html += (_readOnlyError("html"), '<p>Deceduti ' + deceduti + ' </p>');
        }, {
          autoClose: true
        });
      });
